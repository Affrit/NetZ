    ...
    switch(props.currentPage) {
      case 1:
        return [props.pages.slice(props.currentPage - 1, props.currentPage + 6).map(page => {
          return <PageButton currentPage={props.currentPage} setCurrentPage={props.setCurrentPage} page={page}/>}),
          <span>...</span>,
      ...
      case props.pages.length:
        return [<PageButton currentPage={props.currentPage} setCurrentPage={props.setCurrentPage} page={1}/>,
          <span>...</span>,
